...
int main()
{
	...
	fread(pbuff3,sizeof(Elf64_Shdr),500,fp3);
	...
	fread(pbuff4,sizeof(Elf32_Phdr),500,fp4);
    ...
    for(int i = 0;i<pfilehead->e_shnum;++i)
    {
        if(!strncmp(psecheader[i].sh_name + pstrbuff, ".rel", 4))
        {
            ...
            for(int n = 0;n<ncount;++n)
            {
                ...
                fprintf(fp,"  %016lX  ", (psym + ELF64_R_SYM(preltable[n].r_info))->st_value);

                fprintf(fp,"%s + %lu\r", (char*)(prelstrbuf + (psym + ELF64_R_SYM(preltable[n].r_info))->st_name), preltable[n].r_addend);
            }
...
void proheader(const char *pbuff,FILE* fp)
{
    ...
    fprintf(fp,"Entry point 0X%0lX\r", pfilehead->e_entry);
    fprintf(fp,"There are %d program headers, starting at offset %lu\r\n\r", pfilehead->e_phnum, pfilehead->e_phoff);
    fprintf(fp,"Program Headers:\r");
    fprintf(fp,"  %-14s  %-16s  %-16s  %-16s\r", "Type", "Offset", "VirtAddr", "PhysAddr");
    fprintf(fp,"  %-14s  %-16s  %-16s  %-6s  %-6s\r", "", "FileSiz", "MemSiz", "Flags", "Align");
    //travelist program
    for(int i=0;i<pfilehead->e_phnum;++i)
    {
        ...
        {
            case PT_NULL:
                fprintf(fp,"  %-14s  %016lX  %016lX  %016lX\r  %-14s  %016lX  %016lX  ", "", pproheader[i].p_offset, pproheader[i].p_vaddr,
                       pproheader[i].p_paddr, "", pproheader[i].p_filesz, pproheader[i].p_memsz);break;
            case PT_LOAD:
                fprintf(fp,"  %-14s  %016lX  %016lX  %016lX\r  %-14s  %016lX  %016lX  ", "LOAD", pproheader[i].p_offset, pproheader[i].p_vaddr,
                       pproheader[i].p_paddr, "", pproheader[i].p_filesz, pproheader[i].p_memsz);break;
            case PT_DYNAMIC:
                fprintf(fp,"  %-14s  %016lX  %016lX  %016lX\r  %-14s  %016lX  %016lX  ", "DYNAMIC", pproheader[i].p_offset, pproheader[i].p_vaddr,
                       pproheader[i].p_paddr, "", pproheader[i].p_filesz, pproheader[i].p_memsz);break;
            case PT_INTERP:
                fprintf(fp,"  %-14s  %016lX  %016lX  %016lX\r  %-14s  %016lX  %016lX  ", "INTERP", pproheader[i].p_offset, pproheader[i].p_vaddr,
                       pproheader[i].p_paddr, "", pproheader[i].p_filesz, pproheader[i].p_memsz);break;
            case PT_NOTE:
                fprintf(fp,"  %-14s  %016lX  %016lX  %016lX\r  %-14s  %016lX  %016lX  ", "NOTE", pproheader[i].p_offset, pproheader[i].p_vaddr,
                       pproheader[i].p_paddr, "", pproheader[i].p_filesz, pproheader[i].p_memsz);break;
            case PT_SHLIB:
                fprintf(fp,"  %-14s  %016lX  %016lX  %016lX\r  %-14s  %016lX  %016lX  ", "SHLIB", pproheader[i].p_offset, pproheader[i].p_vaddr,
                       pproheader[i].p_paddr, "", pproheader[i].p_filesz, pproheader[i].p_memsz);break;
            case PT_PHDR:
                fprintf(fp,"  %-14s  %016lX  %016lX  %016lX\r  %-14s  %016lX  %016lX  ", "PHDR", pproheader[i].p_offset, pproheader[i].p_vaddr,
                       pproheader[i].p_paddr, "", pproheader[i].p_filesz, pproheader[i].p_memsz);break;
            case PT_TLS:
                fprintf(fp,"  %-14s  %016lX  %016lX  %016lX\r %-14s  %016lX  %016lX  ", "TLS", pproheader[i].p_offset, pproheader[i].p_vaddr,
                       pproheader[i].p_paddr, "", pproheader[i].p_filesz, pproheader[i].p_memsz);break;
            case PT_NUM:
                fprintf(fp,"  %-14s  %016lX  %016lX  %016lX\r  %-14s  %016lX  %016lX  ", "NUM", pproheader[i].p_offset, pproheader[i].p_vaddr,
                       pproheader[i].p_paddr, "", pproheader[i].p_filesz, pproheader[i].p_memsz);break;
            case PT_GNU_EH_FRAME:
                fprintf(fp,"  %-14s  %016lX  %016lX  %016lX\r  %-14s  %016lX  %016lX  ", "GNU_EH_FRAME", pproheader[i].p_offset, pproheader[i].p_vaddr,
                       pproheader[i].p_paddr, "", pproheader[i].p_filesz, pproheader[i].p_memsz);break;
            case PT_GNU_RELRO:
                fprintf(fp,"  %-14s  %016lX  %016lX  %016lX\r  %-14s  %016lX  %016lX  ", "GNU_RELRO", pproheader[i].p_offset, pproheader[i].p_vaddr,
                       pproheader[i].p_paddr, "", pproheader[i].p_filesz, pproheader[i].p_memsz);break;
            case PT_GNU_STACK:
                fprintf(fp,"  %-14s  %016lX  %016lX  %016lX\r  %-14s  %016lX  %016lX  ", "GNU_STACK", pproheader[i].p_offset, pproheader[i].p_vaddr,
                       pproheader[i].p_paddr, "", pproheader[i].p_filesz, pproheader[i].p_memsz);break;
            default:
                break;
        }
        ...
        {
            case PF_X:
                fprintf(fp,"%-6s  %-lX\r", "  E", pproheader[i].p_align);break;
            case PF_W:
                fprintf(fp,"%-6s  %-lX\r", " W ", pproheader[i].p_align);break;
            case PF_R:
                fprintf(fp,"%-6s  %-lX\r", "R  ", pproheader[i].p_align);break;
            case PF_X|PF_W:
                fprintf(fp,"%-6s  %-lX\r", " WE", pproheader[i].p_align);break;
            case PF_X|PF_R:
                fprintf(fp,"%-6s  %-lX\r", "R E", pproheader[i].p_align);break;
            case PF_W|PF_R:
                fprintf(fp,"%-6s  %-lX\r", "RW ", pproheader[i].p_align);break;
            case PF_X|PF_R|PF_W:
        ...
        if(PT_INTERP == pproheader[i].p_type)
            fprintf(fp,"      [Requesting program interpreter: %s]\r", (char*)(pbuff + pproheader[i].p_offset));
    }
    fprintf(fp,"\r\n Section to Segment mapping:\r");
    fprintf(fp,"  Segment Sections...\r");
    for(int i=0;i<pfilehead->e_phnum;++i)
    {
        fprintf(fp,"   %-7d", i);
...
void outputsyminfo(const Elf64_Sym *psym, const char *pbuffstr, int ncount,FILE* fp)
{
    ...
    {
        fprintf(fp,"%6d:  %016lx  %-6lu", i, psym[i].st_value, psym[i].st_size);
